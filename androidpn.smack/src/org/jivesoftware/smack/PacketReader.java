...
class PacketReader {
    ...
    private void parsePackets(Thread thread) {
        try {
        	...
        	// KdweiboLogger.e("PackageReader 332", "Catch an error ",e);
            if (!done) {
    ...
    private void processPacket(Packet packet) {
        ...
        //KdweiboLogger.i("processPacket(Packet packet) {", "processPacket: "+packet.toXML()+",length ["+packet.toXML().length()+"]byte");
