...
public final class ServiceManager {
    ...
    public ServiceManager(Context context) {
        ...
        apiKey = AndroidpnConfiguration.xmppAppKey;
        xmppHost = AndroidpnConfiguration.xmppHost;
        xmppPort = AndroidpnConfiguration.xmppPort+"";
    ...
    public void startService() {
        Thread serviceThread = new Thread(new Runnable() {
            @Override
            public void run() {
                Intent intent = PushDemoService.getIntent();
    ...
    /**
     * 直接读取公共项目的配置 
     * @see org.huofire.common.config#AndroidpnConfiguration
     * @return
     */
    @Deprecated 
    ...
    /**
     * 提供给其它应用设置用户名和密码，屏蔽默认注册[RegisterTask]时使用。
     * @param userName
     * @param password
     */
    public void setAndroidpnAuthInfo(String userName, String password){
		Editor editor = sharedPrefs.edit();
